<script lang="ts">
  ...
  import { PanelLeftOpen, SquarePen, ChevronDown, Check } from "lucide-svelte";
...
<header
  class="sticky top-0 z-50 flex h-[54px] items-center justify-between border-b border-border bg-background px-4"
>
